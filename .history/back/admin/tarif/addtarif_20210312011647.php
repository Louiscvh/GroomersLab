    ...
    <div class="admin__container">
        <form method="post" action="../../core/tarif/addtarif.php">
            ...
            <div class="param__section">
                <a id="oui" class="lien" href="?action=choose">Selectionnez une section</a>
                <a class="lien" href="?action=add">Ajouter une section</a>
            </div>
            <div>
            ...
            </div><?php if (isset($_GET['action']) && $_GET['action'] == 'add') { ?>
